...
urlpatterns = [
    ...
    path('admin/order/ship', views.admin.order.ship),
    path('admin/order/refund_approve', views.admin.order.refund_approve),
    path('admin/order/refund_reject', views.admin.order.refund_reject),
    ...
    path('index/user/pwd_strength', views.index.user.pwd_strength),
    ...
    path('index/order/confirm', views.index.order.confirm),
    path('index/order/complete', views.index.order.complete),
    path('index/order/refund_apply', views.index.order.refund_apply),
